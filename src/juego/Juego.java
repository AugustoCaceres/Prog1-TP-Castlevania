...
public class Juego extends InterfaceJuego {
	...
	//crear los elementos est·ticos del juego
	...
	public void dibujarVelocirraptor() {
		...
		for (int i = 0; i < velocirraptors.length; i++) {
			...
			//si el velocirraptor en la posiciÛn i es nulo, o sea que lo matÛ barbarianna
			else {
				
				//espera a que el contador que est· en thick llegue a 150
				if (segundos == 150) {
					//crea en esa posiciÛn un velocirraptor y lo dibuja en el extremo superior derecho de la pantalla. TambiÈn reinicia los segundos
	...
	//para chequear si colisionan barbarianna y alg˙n velocirraptor
	...
	public boolean vidas() {
		...
		//parte que verifica que a˙n quedan vidas
	...
	//mÈtodo que actualiza la posiciÛn del trueno thick a thick
	public void actualizarPosicionTrueno() {
		...
		if (this.rayo != null) {
			...
			//si el x de rayo no entra en los otros if el rayo deberÌa eliminarse 
			//pero no pasa eso
			else { 
	...
	//mÈtodo que elimina al velocirraptor que haya colisionado con el trueno de barbarianna
	...
	//para chequear que colisionan el trueno de barbarianna con alg˙n velocirraptor
